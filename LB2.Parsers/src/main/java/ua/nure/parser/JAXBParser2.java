...
//		marshaller.setProperty(null, schemaFactory);
		...
		JAXBElement<Book> jbook = new JAXBElement<>(
				new QName(Const.BOOKS__NAMESPACE_URI, "book"),
				Book.class, book);
		
		marshaller.marshal(jbook, new File("oneBook.xml"));
	}
}