...
public class Stax2Parser {
    ...
    public static void main(String[] args) throws Exception {
        ...
        List<Book> books = parser.parse(new FileInputStream(Const.XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the books: \n" + books);
        System.out.println("====================================");
        books = parser.parse(new FileInputStream(Const.INVALID_XML_FILE), Const.XSD_FILE);
        System.out.println("====================================");
        System.out.println("Here is the invalid books: \n" + books);
        System.out.println("====================================");
    }

    private List<Book> parse(InputStream in, String schemaFile) throws XMLStreamException {
